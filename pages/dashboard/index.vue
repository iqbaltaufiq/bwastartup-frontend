          ...
          >
            <div class="mb-8">
              ...
              <p class="text-sm text-gray-600 flex items-center mb-2">
                Rp. {{ new Intl.NumberFormat().format(campaign.goal_amount) }} &middot; {{ Math.round(100 * campaign.current_amount / campaign.goal_amount) }}%
              </p>
...
export default {
  ...
  async asyncData({ $axios, app }) {
    let campaigns = await $axios.$get("/api/v1/campaigns?user_id=" + app.$auth.user.id)
