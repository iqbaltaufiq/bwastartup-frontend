        ...
        <div class="w-1/4">
          ...
          >
            ...
            <div class="flex mt-3">
              <div class="w-1/4">
                <img
                  :src="campaign.data.User.image_url ? $axios.defaults.baseURL + '/' + campaign.data.User.image_url : '/testimonial-1-icon.png'" 
                  alt=""
      ...
      <div class="flex justify-between items-center">
        <div class="w-full md:w-3/4 mr-6">
          ...
          <div class="relative progress-bar">
            ...
            >
              <div
                :style="'width:'+ Math.round(100 * campaign.data.current_amount / campaign.data.goal_amount) +'%'"
          ...
          <div class="flex progress-info mb-6">
            <div class="text-2xl">
              {{ Math.round(100 * campaign.data.current_amount / campaign.data.goal_amount) }}%
            </div>
